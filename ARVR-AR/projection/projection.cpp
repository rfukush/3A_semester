...
int main( int argc, char* argv[] ){
  ...
  cvPutText( output, "(20 mm, 60 mm)", cvPointFrom32f( projectedPoints[4]), 
    &font, CV_RGB(255, 0, 0));

  cvPutText( output, "(40 mm, 120 mm)", cvPointFrom32f( projectedPoints[5]), 
    &font, CV_RGB(255, 0, 0));
...
void project( CvPoint3D32f* objectPoint, CvPoint2D32f* projectedPoint, 
  ...
  projected[1] = A[1][0] * tmp[1] + A[1][1] * tmp[1] + A[1][2] * tmp[2];
  projected[2] = A[2][0] * tmp[2] + A[2][1] * tmp[1] + A[2][2] * tmp[2];
